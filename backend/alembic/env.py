...
# Set database URL from our settings (overrides alembic.ini value)
...
def run_migrations_offline() -> None:
    ...
    Outputs SQL to stdout without connecting to the DB.
    """
...
def do_run_migrations(connection: Connection) -> None:
    context.configure(
        ...
        compare_server_default=True,
        include_schemas=True,
        # Ensure enums are created/dropped correctly
